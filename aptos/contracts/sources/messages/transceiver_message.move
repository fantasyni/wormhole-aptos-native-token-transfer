module wormhole_ntt::transceiver_message {
    ...
    struct TransceiverMessage {
        ...
        recipient_ntt_manager_address: NttExternalAddress,
    ...
    fun encode_transceiver_message(
        ...
        vector::append(&mut buf, ntt_external_address::to_bytes(source_ntt_manager_address));
        vector::append(&mut buf, ntt_external_address::to_bytes(recipient_ntt_manager_address));
    ...
    fun parse_transceiver_message(
        ...
        let source_ntt_manager_address = ntt_external_address::take_bytes(&mut cur);
        let recipient_ntt_manager_address = ntt_external_address::take_bytes(&mut cur);
    ...
    public(friend) fun parse_transceiver_and_ntt_manager_message(
        payload: vector<u8>
    ): (NttExternalAddress, NttExternalAddress, NttManagerMessage) {
