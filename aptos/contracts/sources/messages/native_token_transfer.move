module wormhole_ntt::native_token_transfer {
    ...
    struct NativeTokenTransfer {
        ...
        source_token: NttExternalAddress,
        // Address of the recipient. Left-zero-padded if shorter than 32 bytes.
        to: NttExternalAddress,
    ...
    public(friend) fun encode_native_token_transfer(
        ...
        vector::append(&mut buf, ntt_external_address::to_bytes(source_token));
        vector::append(&mut buf, ntt_external_address::to_bytes(to));
    ...
    public(friend) fun parse_native_token_transfer(
        ...
        let source_token = ntt_external_address::take_bytes(&mut cur);
        let to = ntt_external_address::take_bytes(&mut cur);
